...
{
    [Fact]
    public void ResolvePlanningUserToken_PreservesCandidateAliasesAndUsesOidAsPrimary()
    {
        ...
        Assert.Equal("11111111-2222-3333-4444-555555555555", context.PrimaryUserId);
    ...
    [Fact]
    public void ResolvePlanningUserToken_RemainsStableWhenPreferredUsernameIsMissing()
    {
        var principal = new ClaimsPrincipal(new ClaimsIdentity(
        [
            new Claim("name", "Planner Display Name"),
        ...
        Assert.Equal("11111111-2222-3333-4444-555555555555", context.PrimaryUserId);
        Assert.Equal(["11111111-2222-3333-4444-555555555555", "Planner Display Name"], context.CandidateUserIds);
    }
