...
public sealed class InMemoryPlanningRepository : IPlanningRepository, IDisposable
{
    ...
    public Task<GridSliceResponse> GetGridSliceAsync(long scenarioVersionId, long? selectedStoreId, IReadOnlyCollection<long>? expandedProductNodeIds, bool expandAllBranches, CancellationToken cancellationToken) => _inner.GetGridSliceAsync(scenarioVersionId, selectedStoreId, expandedProductNodeIds, expandAllBranches, cancellationToken);
