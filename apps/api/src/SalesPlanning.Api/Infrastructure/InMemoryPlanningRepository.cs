...
public sealed class InMemoryPlanningRepository : IPlanningRepository, IDisposable
{
    ...
    public Task<IReadOnlyList<PlanningCell>> GetDraftCellsAsync(long scenarioVersionId, string userId, IEnumerable<PlanningCellCoordinate> coordinates, CancellationToken cancellationToken) => Task.FromResult<IReadOnlyList<PlanningCell>>([]);
    ...
    public Task UpsertDraftCellsAsync(long scenarioVersionId, string userId, IEnumerable<PlanningCell> cells, CancellationToken cancellationToken) => _inner.UpsertCellsAsync(cells, cancellationToken);
    ...
    public Task<long> GetNextDraftCommandBatchIdAsync(CancellationToken cancellationToken) => _inner.GetNextCommandBatchIdAsync(cancellationToken);
    public Task AppendDraftCommandBatchAsync(PlanningCommandBatch batch, CancellationToken cancellationToken) => _inner.AppendCommandBatchAsync(batch, cancellationToken);
    ...
    public Task<PlanningUndoRedoAvailability> GetDraftUndoRedoAvailabilityAsync(long scenarioVersionId, string userId, int limit, CancellationToken cancellationToken) => _inner.GetUndoRedoAvailabilityAsync(scenarioVersionId, userId, limit, cancellationToken);
    public Task<PlanningCommandBatch?> UndoLatestDraftCommandAsync(long scenarioVersionId, string userId, int limit, CancellationToken cancellationToken) => _inner.UndoLatestCommandAsync(scenarioVersionId, userId, limit, cancellationToken);
    public Task<PlanningCommandBatch?> RedoLatestDraftCommandAsync(long scenarioVersionId, string userId, int limit, CancellationToken cancellationToken) => _inner.RedoLatestCommandAsync(scenarioVersionId, userId, limit, cancellationToken);
    ...
    public Task CommitDraftAsync(long scenarioVersionId, string userId, CancellationToken cancellationToken) => Task.CompletedTask;
