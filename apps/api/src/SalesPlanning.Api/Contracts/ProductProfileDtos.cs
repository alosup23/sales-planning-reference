...
public sealed record ProductProfileDto(
    ...
    string? ColourFamily = null,
    bool KviFlag = false,
    bool MarkdownEligible = true,
    decimal? MarkdownFloorPrice = null,
    decimal? MinimumMarginPct = null,
    string? PriceLadderGroup = null,
    string? GoodBetterBestTier = null,
    string? SeasonCode = null,
    string? EventCode = null,
    string? LaunchDate = null,
    string? EndOfLifeDate = null,
    string? SubstituteGroup = null,
    string? CompanionGroup = null,
    string? ReplenishmentType = null,
    int? LeadTimeDays = null,
    int? Moq = null,
    int? CasePack = null,
    decimal? StartingInventory = null,
    decimal? ProjectedStockOnHand = null,
    decimal? SellThroughTargetPct = null,
    decimal? WeeksOfCoverTarget = null);
